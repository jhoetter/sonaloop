...
def brief_presentation(synthesis_id: str, audience: str = "stakeholder",
    ...
    return {
        ...
        "instructions": [
            ...
            "Write concrete standalone headlines, normally 3–8 words and never more than 10 words or 56 characters; avoid unexplained pronouns, internal phase names and bare variant letters before the stimuli are introduced.",
