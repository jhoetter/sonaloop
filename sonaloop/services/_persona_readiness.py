...
def persona_readiness(persona_id: str, store: Store | None = None) -> dict[str, Any]:
    ...
    grounding_score = 15 if evidence >= 2 else 9 if evidence == 1 else 0
    ...
    next_action = (
        ...
        "attach_independent_evidence" if not evidence else
...
def brief_persona_memory_onboarding(persona_id: str, days: int = 28,
    ...
    first_tool = {
        ...
        "attach_independent_evidence": "attach_evidence",
    ...
    return {
        ...
        "workflow": [
            ...
            {"step": 7, "tool": "evaluate_simulation_full", "purpose": "critic-check specificity and continuity"},
            {"step": 8, "tool": "persona_readiness", "purpose": "verify the persona is no longer thin"},
        ],
