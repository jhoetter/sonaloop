...
INSPECTOR_SECTIONS = [
    ...
    ("runs", "play",
     ...
     ("Oben in der Leiste zeigt ein Status-Punkt, ob gerade Studien **aktiv** laufen — er wird "
      ...
      "mit jedem Projekt-Run und seiner letzten Aktivität. **Läuft · stockt · nach 24 Stunden "
      "abgelaufen (fortsetzbar) · Engine-abgeschlossen · Ausgabe unverifiziert** sind getrennte "
      "Zustände. Abgelaufen verändert das aktive Journal nicht und sagt nichts über die "
      ...
      "Exports und MCP-Metadaten geteilte `sltrace_*`-Workflow-ID verbindet dagegen den gesamten "
      "Job über wechselnde Requests. Cohort-Preflight-Ergebnisse erscheinen "
      ...
      "project run with its last activity. **Running · stalled · expired after 24 hours "
      "(resumable) · engine-finished · output unverified** are distinct states. Expiry does not "
      "change the active journal and says nothing about evidence quality. A problem first shows a "
