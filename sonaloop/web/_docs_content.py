...
INSPECTOR_SECTIONS = [
    ("orientation", "book",
     ...
     ("Die Seitenleiste hat genau **vier** Einträge: **Projekte · Personas · Library · Activity** "
      ...
      "Primitives sind die obere Ebene; **Subtypes/Formate** verfeinern sie, ohne neue Dinge zu "
      "erfinden: Red-Team und Head-to-head sind Council-Formate, Website/externer Prototyp/A-B "
      "sind Referenz-Subtypes, Flow/Prototype/Live sind Session-Subjects. "
      ...
      "cross-project browser over those same primitives. Primitives are the top level; "
      "**subtypes/formats** refine them without creating new things: red-team and head-to-head "
      "are council formats, website/external prototype/A-B are reference subtypes, and "
      "flow/prototype/live are session subjects. Naming rule: **References** are websites, "
