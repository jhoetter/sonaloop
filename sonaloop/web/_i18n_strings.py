...
STRINGS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "job_h": "Job",
        "job_d": "Was du herausfinden willst: Positioning, Pricing, Demand, Churn.",
        "methodology_d": "Der Prozess, der die Studie von offenem Problem zu belastbarer Antwort führt.",
        "format_h": "Format",
        "format_d": "Ein einzelner Move im Prozess: Council, Head-to-Head, Red-Team oder Prototype Test.",
        "methodologies_lead": "Methodiken sind die Prozesse, die ein Projekt strukturiert durchläuft.",
        "methodologies_intro": "Ein Projekt startet mit einer Forschungsfrage. Die Methodik entscheidet, in welcher Reihenfolge Sonaloop öffnet, verdichtet, baut, testet und am Ende übergibt. Formate sind die einzelnen Moves innerhalb dieses Ablaufs.",
        "stages_h": "Phasen",
        "good_for_h": "Geeignet für",
        "engine_h": "Engine",
        "engine_d": "Analyze -> Act -> Verify; Konvergenz braucht evidenzgestützte Gates.",
        ...
        "tour_plan_h": "Plan: wie dieses Projekt entstanden ist", "tour_plan_d": "Jedes Beispiel hat einen Plan. Hier siehst du Methodik und Run-Status, also ob das Projekt frei oder entlang eines Frameworks wie Double Diamond entstanden ist.",
        ...
        "tour_gate_h": "Gate: Evidenz muss irgendwo landen", "tour_gate_d": "Wenn ein Plan abgeschlossen ist, darf ein Survey, eine Session oder ein Asset nicht lose herumliegen. Die Gate-Kanten zeigen, welche Evidenz den Report oder die Entscheidung trägt.",
    ...
    "en": {
        ...
        "job_h": "Job",
        "job_d": "What you want to learn: positioning, pricing, demand, churn.",
        "methodology_d": "The process that moves a study from open problem to reliable answer.",
        "format_h": "Format",
        "format_d": "One move in the process: council, head-to-head, red-team or prototype test.",
        "methodologies_lead": "Methodologies are the processes a project runs through.",
        "methodologies_intro": "A project starts with a research question. The methodology decides the order in which Sonaloop diverges, converges, builds, tests and hands off. Formats are the individual moves inside that process.",
        "stages_h": "Stages",
        "good_for_h": "Good for",
        "engine_h": "Engine",
        "engine_d": "Analyze -> Act -> Verify; convergence needs evidence-backed gates.",
        ...
        "tour_plan_h": "Plan: how this project was made", "tour_plan_d": "Every example has a plan. This shows methodology and run state, so you can tell whether a project was freeform or driven by a framework such as Double Diamond.",
        ...
        "tour_gate_h": "Gate: evidence must land somewhere", "tour_gate_d": "Once a plan is complete, a survey, session or asset should not float loose. Gate edges show which evidence supports the report or decision.",
