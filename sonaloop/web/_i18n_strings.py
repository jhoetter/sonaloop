...
STRINGS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "health_attention_stalled": "Dieser Run wartet auf Fortsetzung.", "health_attention_unverified": "Die Ausgabe ist noch nicht als abgeschlossen verifiziert.",
    ...
    "en": {
        ...
        "health_attention_stalled": "This run is waiting to be resumed.", "health_attention_unverified": "The output has not yet been verified as complete.",
