...
STRINGS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "filter_h": "Filter", "filter_is": "ist", "filter_no_options": "Keine Optionen", "filter_no_matches_h": "Nichts entspricht den Filtern", "filter_no_matches": "Keine Zeilen entsprechen diesen Filtern — lockere sie oder setze sie zurück.", "phase_h": "Phase", "persona_h": "Persona", "status_h": "Status", "subtype_h": "Format",  # FilterBar (UX U10)
        ...
        "flows_lead": "Wiederverwendbare Testabläufe für Sessions — aktuell Screen-Walkthroughs aus Screenshot-Assets.", "no_flows": "Noch keine Playbooks.", "prototypes_lead": "Lauffähige Prototypen — von Personas getestet.", "no_prototypes": "Noch keine Prototypen.",
        ...
        "prototypes_teach": "Scaffolde einen klickbaren Prototyp aus einem Konzept (scaffold_prototype).", "flows_teach": "Definiere ein Screen-Walkthrough-Playbook aus Screenshot-Assets (define_flow).", "sessions_teach": "Lass eine Persona ein Playbook, einen Prototyp oder eine Live-URL benutzen (record_usability_session, record_prototype_session).",
        ...
        "session_kind_artifact": "Walkthrough-Session", "live_surface": "Live-Oberfläche", "walkthrough_surface": "Playbook", "replays_h": "Replays", "proto_sessions_h": "Prototyp-Sessions",
        ...
        "tour_report_h": "Report: Verdichten und übergeben", "tour_report_d": "Reports fassen Councils, Sessions und Befunde zusammen. Sie sind zitierbare Deliverables, nicht lose Zusammenfassungen.", "tour_flow_h": "Playbook: den Testablauf festlegen", "tour_flow_d": "Playbooks beschreiben, wie eine Session läuft. Dieses Beispiel ist ein Screen-Walkthrough aus echten Screens; die Persona reagiert Schritt für Schritt.", "tour_prototype_h": "Prototype: Dinge benutzbar machen", "tour_prototype_d": "Prototypen sind echte lokale Artefakte. Personas können sie per Browser-Harness nutzen; die Reaktionen werden wieder Teil des Graphen.",
    ...
    "en": {
        ...
        "filter_h": "Filter", "filter_is": "is", "filter_no_options": "No options", "filter_no_matches_h": "Nothing matches these filters", "filter_no_matches": "No rows match these filters — loosen or clear them.", "phase_h": "Phase", "persona_h": "Persona", "status_h": "Status", "subtype_h": "Format",  # FilterBar (UX U10)
        ...
        "flows_lead": "Reusable test plans for sessions — currently screen walkthroughs made from screenshot assets.", "no_flows": "No playbooks yet.", "prototypes_lead": "Runnable prototypes — tested by personas.", "no_prototypes": "No prototypes yet.",
        ...
        "prototypes_teach": "Scaffold a clickable prototype from a concept (scaffold_prototype).", "flows_teach": "Define a screen walkthrough playbook from screenshot assets (define_flow).", "sessions_teach": "Have a persona use a playbook, prototype, or live URL (record_usability_session, record_prototype_session).",
        ...
        "session_kind_artifact": "Walkthrough session", "live_surface": "Live surface", "walkthrough_surface": "Playbook", "replays_h": "Replays", "proto_sessions_h": "Prototype sessions",
        ...
        "tour_report_h": "Report: synthesize and hand off", "tour_report_d": "Reports consolidate councils, sessions, and findings into a citable deliverable instead of a loose summary.", "tour_flow_h": "Playbook: define the test run", "tour_flow_d": "Playbooks define how a session runs. This example is a screen walkthrough from real screens; the persona reacts step by step.", "tour_prototype_h": "Prototype: make it usable", "tour_prototype_d": "Prototypes are real local artifacts. Personas can drive them through the browser harness, and the reactions return to the graph.",
