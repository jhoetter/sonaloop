...
STRINGS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "project_form_lead": "Nur die Struktur: Titel, Ziel und Beschreibung des Job-Containers.",
        ...
        "methodologies_intro": "Ein Job startet mit einer Forschungsfrage. Die Methodik entscheidet, in welcher Reihenfolge Sonaloop öffnet, verdichtet, baut, testet und am Ende übergibt. Formate sind die einzelnen Moves innerhalb dieses Ablaufs.",
        "stages_h": "Phasen",
    ...
    "en": {
        ...
        "project_form_lead": "Structure only: the job container's title, goal and description.",
        ...
        "methodologies_intro": "A job starts with a research question. The methodology decides the order in which Sonaloop diverges, converges, builds, tests and hands off. Formats are the individual moves inside that process.",
        "stages_h": "Stages",
        "good_for_h": "Good for",
        "engine_h": "Engine",
