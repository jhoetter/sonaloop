...
STRINGS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "product_understanding_h": "Product Understanding", "product_understanding_missing": "Preflight fehlt",
        "product_understanding_missing_help": "Der Reaction Test wartet auf eine evidenzbasierte Inventur des echten Produkts.",
        "pu_revision": "Revision", "pu_manifest": "Flow-Manifest", "pu_observed_present": "beobachtet vorhanden",
        "pu_observed_absent": "beobachtet abwesend", "pu_inferred": "abgeleitet", "pu_unknown": "unbekannt",
        "pu_capabilities_n": "{n} Fähigkeiten", "pu_unknown_n": "{n} unbekannt",
        "pu_conflicts_n": "{n} widersprüchliche Revisionen", "pu_verified_absences_n": "{n} verifizierte Abwesenheiten",
        "cohort_integrity_h": "Cohort Integrity", "cohort_integrity_missing": "Preflight fehlt",
        "cohort_integrity_missing_help": "Der Reaction Test wartet auf die serverseitige Prüfung von Tiefe, Herkunft, Hypothesen-Überlappung und Gegenstimmen.",
        ...
        "cohort_countervoices_n": "{n} Gegenstimmen", "cohort_unverified_countervoices_n": "{n} Gegenstimmen ungeprüft", "cohort_thin_n": "{n} dünn",
        ...
        "cohort_age_unknown": "Alter unbekannt", "cohort_age_hours": "{n} h alt",
        "cohort_persona_summary": "{name}: {items} unabhängige Elemente · {origin} · {age}", "cohort_persona_thin": "dünner Kontext",
        ...
        "health_h": "Evidenz- und Run-Gesundheit", "health_unmet": "Unerfüllte Invariante",
        "health_last_success": "Letzte sichere Operation", "health_safe_next": "Sicherer nächster Schritt",
        "health_trace": "Support-Trace", "health_external_limit": "Externer Host nicht vollständig beobachtbar",
        "health_running": "läuft", "health_stalled": "stockt", "health_finished": "Engine-abgeschlossen",
        "health_unverified": "Ausgabe unverifiziert", "health_archived": "archiviert", "health_superseded": "ersetzt",
    ...
    "en": {
        ...
        "product_understanding_h": "Product Understanding", "product_understanding_missing": "Preflight missing",
        "product_understanding_missing_help": "The Reaction Test is waiting for an evidence-bound inventory of the real product.",
        "pu_revision": "revision", "pu_manifest": "flow manifest", "pu_observed_present": "observed present",
        "pu_observed_absent": "observed absent", "pu_inferred": "inferred", "pu_unknown": "unknown",
        "pu_capabilities_n": "{n} capabilities", "pu_unknown_n": "{n} unknown",
        "pu_conflicts_n": "{n} contradictory revisions", "pu_verified_absences_n": "{n} verified absences",
        "cohort_integrity_h": "Cohort Integrity", "cohort_integrity_missing": "Preflight missing",
        "cohort_integrity_missing_help": "The Reaction Test is waiting for the server-owned depth, provenance, hypothesis-overlap and countervoice check.",
        ...
        "cohort_countervoices_n": "{n} countervoices", "cohort_unverified_countervoices_n": "{n} countervoices unverified", "cohort_thin_n": "{n} thin",
        ...
        "cohort_age_unknown": "age unknown", "cohort_age_hours": "{n} h old",
        "cohort_persona_summary": "{name}: {items} independent items · {origin} · {age}", "cohort_persona_thin": "thin context",
        ...
        "health_h": "Evidence and run health", "health_unmet": "Unmet invariant",
        "health_last_success": "Last safe operation", "health_safe_next": "Safe next action",
        "health_trace": "Support trace", "health_external_limit": "External host not fully observable",
        "health_running": "running", "health_stalled": "stalled", "health_finished": "engine-finished",
        "health_unverified": "output unverified", "health_archived": "archived", "health_superseded": "superseded",
