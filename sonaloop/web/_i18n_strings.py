...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "primitive_h": "Primitive", "primitive_family_frame": "Frame", "primitive_family_material": "Material", "primitive_family_ask": "Ask", "primitive_family_test": "Test", "primitive_family_capture": "Capture", "primitive_family_conclude": "Conclude", "primitive_family_structure": "Structure",
        "primitive_open_question_purpose": "a research question that still needs resolution", "primitive_reference_purpose": "linked material: website, external prototype or variant", "primitive_asset_purpose": "a stored file: evidence in or deliverable out", "primitive_council_purpose": "a moderated round: the mediator asks, personas answer from memory", "primitive_survey_purpose": "a structured questionnaire for real responses", "primitive_prototype_purpose": "an interactive surface personas can actually use", "primitive_flow_purpose": "a fixed screen sequence from assets, not clickable like a prototype", "primitive_session_purpose": "a recorded test run through a flow, prototype or live URL", "primitive_hypothesis_purpose": "a testable assumption, not an answer yet", "primitive_decision_purpose": "an evidence-backed commitment record: what we do now", "primitive_synthesis_purpose": "an analysis that turns evidence into interpretation", "primitive_report_purpose": "a presentation-ready analysis report", "primitive_note_purpose": "a captured signal, observation or concept", "primitive_section_purpose": "a grouping over existing nodes",
